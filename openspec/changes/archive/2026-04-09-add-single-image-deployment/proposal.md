...
- **`MONGODB_URI` becomes optional**: The Zod env schema makes `MONGODB_URI` optional with an automatic fallback to the embedded instance (`mongodb://127.0.0.1:27017/archmax`).
