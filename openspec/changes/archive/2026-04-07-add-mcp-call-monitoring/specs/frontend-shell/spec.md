...
#### Scenario: Navigate to Monitoring

- **WHEN** the user clicks the Monitoring nav item
- **THEN** the URL changes to `/<projectId>/monitoring`
- **AND** the Monitoring item is highlighted as active
- **AND** the MCP call log table is displayed
