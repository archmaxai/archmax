  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "group-data-[variant=pill]/tabs-list:data-[state=active]:!bg-muted group-data-[variant=pill]/tabs-list:data-[state=active]:text-foreground dark:group-data-[variant=pill]/tabs-list:data-[state=active]:!bg-muted",
