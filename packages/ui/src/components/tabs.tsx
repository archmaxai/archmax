  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "group-data-[variant=pill]/tabs-list:data-[state=active]:!bg-card group-data-[variant=pill]/tabs-list:data-[state=active]:text-foreground group-data-[variant=pill]/tabs-list:data-[state=active]:shadow-sm dark:group-data-[variant=pill]/tabs-list:data-[state=active]:!bg-muted dark:group-data-[variant=pill]/tabs-list:data-[state=active]:shadow-none",
