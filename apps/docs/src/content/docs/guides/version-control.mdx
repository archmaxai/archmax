...
The **Settings** page shows a publish history card with the last 10 publishes, including the commit message and timestamp for each. This gives you a quick changelog without leaving the UI.
