...
Run archmax as a single container with embedded MongoDB and Redis — no external dependencies:
...
**Best for**: quick evaluation, simple deployments, and users who prefer a single-container setup.
