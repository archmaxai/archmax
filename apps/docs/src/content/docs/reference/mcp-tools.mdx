...
**Returns:** Compressed markdown digest (not raw YAML). Each dataset row includes its corresponding `_scope_<modelName>."<datasetName>"` VIEW name for use in queries.
